...
oc create secret generic svc-cus-interactions-stress-keytab --from-file=./SVC_CST_CusCache_uat.keytab
...
oc rollout latest dc/cst-customer-interaction-events-transformer -n idna-cis-fusebusinessobject-stress