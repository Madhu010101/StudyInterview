...
oc delete secret svc-cus-cache-stress-keytab

oc create secret generic svc-cus-cache-stress-keytab --from-file=./SVC_CST_CusCache_uat.keytab
...
oc create configmap cst-product-holding-schema-configmap --from-file=./BusinessObject.avsc
