...
oc delete secret eeh-non-prod-keystore

oc create secret generic eeh-non-prod-keystore --from-file=./keystore.jks

oc delete secret eeh-non-prod-truststore
...
oc create configmap partymaster-schema --from-file=./partymasterSourceBusinessObject.avsc
