...
public class Cis1358ZosPayloadResponse {
    ...
    private List<WarningTable> warningTable = null;
    @JsonIgnore
    ...
    @JsonProperty("warningTable")
    public List<WarningTable> getWarningTable() {
        return warningTable;
    }

    @JsonProperty("warningTable")
    public void setWarningTable(List<WarningTable> warningTable) {
