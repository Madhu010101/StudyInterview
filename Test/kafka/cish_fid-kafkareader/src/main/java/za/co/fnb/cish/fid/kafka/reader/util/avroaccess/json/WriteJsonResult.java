...
import za.co.fnb.cish.fid.kafka.reader.util.avroaccess.serialization.AbstractRecordSetWriter;
...
import za.co.fnb.cish.fid.kafka.reader.util.avroaccess.serialization.record.type.ChoiceDataType;
...
public class WriteJsonResult extends AbstractRecordSetWriter implements RecordSetWriter, RawRecordWriter {
    ...
    public WriteJsonResult(final RecordSchema recordSchema, final SchemaAccessWriter schemaAccess, final OutputStream out, final boolean prettyPrint,
