...
public class JacksonJsonTreeRowRecordReader extends AbstractJacksonJsonRowRecordReader {
    ...
    public JacksonJsonTreeRowRecordReader(final RecordSchema schema, final String dateFormat, final String timeFormat,
                                          final String timestampFormat) throws IOException, MalformedRecordException {
        super();
        this.schema = schema;
