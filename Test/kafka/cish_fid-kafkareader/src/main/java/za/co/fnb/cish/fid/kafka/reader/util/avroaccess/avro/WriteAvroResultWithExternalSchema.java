...
public class WriteAvroResultWithExternalSchema extends AbstractRecordSetWriter {
    ...
    public WriteAvroResultWithExternalSchema(final Schema avroSchema, final RecordSchema recordSchema, final SchemaAccessWriter schemaAccessWriter, final OutputStream out) throws IOException {
        super(out);
