...
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', 'DCTM', 'DOCUMENTUM', 'STM_TP', 'DCTM', 'DOCUMENTUM', 'DCTM', '2022-11-01', null);
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', 'PROCEP', 'PLATFORM REGISTRATION', 'STM_TP', 'PROCEP', 'PLATFORM REGISTRATION', 'PROCEP', '2024-04-30', null);
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', 'RNH', 'RELATIONSHIPS AND HIERARCHIES (RNH)', 'STM_TP', 'RNH', 'RELATIONSHIPS AND HIERARCHIES (RNH)', 'RNH', '2024-04-30', null);
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', 'OEDQ', 'ORACLE ENTERPRISE DATA QUALITY (OEDQ)', 'STM_TP', 'OEDQ', 'ORACLE ENTERPRISE DATA QUALITY (OEDQ)', null, null, null);
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', null, null, 'STM_TP', '-2', 'FIELD NOT APPLICABLE TO SOURCE', 'NOT APPLICABLE', '2022-01-01', null);
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', null, null, 'STM_TP', '0', 'SOURCE CODE IS NOT FOUND IN LOOKUP', 'NOT FOUND', '2022-01-01', null);
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq'), null, null, 'SOURCE SYSTEM', null, null, 'STM_TP', '-1', 'SOURCE CODE IS BLANK OR NULL', 'BLANK', '2022-01-01', null);
commit;
