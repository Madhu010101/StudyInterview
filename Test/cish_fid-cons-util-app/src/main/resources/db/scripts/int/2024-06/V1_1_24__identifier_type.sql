...
DROP SEQUENCE IF EXISTS cishfid.identifier_type_id_seq;
...
INSERT INTO cishfid.identifier_type (id, stm_tp_cd, src_tbl_no, src_cat, stm_tp_src_cd, idfr_src_tp_cd, idfr_src_tp_desc, tbl_nme, idfr_tp_cd, idfr_tp_desc, idfr_efctv_dt, idfr_expry_dt) VALUES (nextval('cishfid.identifier_type_id_seq'),'CRE',null, 'IDENTIFIER_TYPE', 'SOURCE IDENTIFIER', 'SSOID','SSO IDENTIFIER', 'IDFR_TP', '3', 'SSO IDENTIFIER', '2022-01-01', null);
INSERT INTO cishfid.identifier_type (id, stm_tp_cd, src_tbl_no, src_cat, stm_tp_src_cd, idfr_src_tp_cd, idfr_src_tp_desc, tbl_nme, idfr_tp_cd, idfr_tp_desc, idfr_efctv_dt, idfr_expry_dt) VALUES (nextval('cishfid.identifier_type_id_seq'),'OPM',null, 'IDENTIFIER_TYPE', 'SOURCE IDENTIFIER', 'FID','FIRST ID', 'IDFR_TP', '4', 'FIRST ID', '2022-01-01', null);
INSERT INTO cishfid.identifier_type (id, stm_tp_cd, src_tbl_no, src_cat, stm_tp_src_cd, idfr_src_tp_cd, idfr_src_tp_desc, tbl_nme, idfr_tp_cd, idfr_tp_desc, idfr_efctv_dt, idfr_expry_dt) VALUES (nextval('cishfid.identifier_type_id_seq'),'CIS',null, 'IDENTIFIER_TYPE', 'SOURCE IDENTIFIER', 'CONTAINER ID','CONTAINER ID', 'IDFR_TP', '5', 'CIS CONTAINER NUMBER', '2024-02-01', null);
INSERT INTO cishfid.identifier_type (id, stm_tp_cd, src_tbl_no, src_cat, stm_tp_src_cd, idfr_src_tp_cd, idfr_src_tp_desc, tbl_nme, idfr_tp_cd, idfr_tp_desc, idfr_efctv_dt, idfr_expry_dt) VALUES (nextval('cishfid.identifier_type_id_seq'),null,null, null, null, null,null, 'IDFR_TP', '6', 'OFFICER CODE', '2024-05-03', null);
