...
INSERT INTO cishfid.system (id, src_tbl_no, src_tbl_nme, src_cat, stm_src_tp_cd, stm_src_tp_desc, tbl_nme, stm_tp_cd, stm_tp_long_desc, stm_tp_short_desc, stm_efctv_dt, stm_expry_dt) VALUES (nextval('cishfid.system_id_seq')  , null, null, 'SOURCE SYSTEM', 'OCM', 'COMPLIANCE MASTER', 'STM_TP', 'OCM', 'OPERATIONAL COMPLIANCE MASTER', 'OCM', '2023-06-20', null);
